...
Функционал: <1. ВПС, менее 15 000р, нал выплата>
...
Сценарий: <Проверяем выплату "Все по 100" билетов меньше 15000. Наличная выплата>
...
И в таблице "Билеты" я изменяю флаг с именем 'БилетыНеобходимаЭкспертиза'
И в таблице "Билеты" я завершаю редактирование строки
