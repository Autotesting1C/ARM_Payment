...
Функционал: <5. Mercury, более 15 000р но менее 600 000р , нал выплата>
...
Сценарий: <Проверяем выплату билетов моментальных лотерей свыше 15000, но меньше 600 000 рублей. Наличная выплата>
