...
Функциональность: 1. Дымовые тесты "Справочники"
...
Сценарий: Открытие формы списка "РегистрацияВыплатыВручнуюПрисоединенныеФайлы" 

	Дано Я открываю основную форму списка справочника "РегистрацияВыплатыВручнуюПрисоединенныеФайлы"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму справочника РегистрацияВыплатыВручнуюПрисоединенныеФайлы"
	И Я закрываю текущее окно

Сценарий: Открытие формы объекта "РегистрацияВыплатыВручнуюПрисоединенныеФайлы"

	Дано Я открываю основную форму справочника "РегистрацияВыплатыВручнуюПрисоединенныеФайлы"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму справочника РегистрацияВыплатыВручнуюПрисоединенныеФайлы"
	И Я закрываю текущее окно
	
Сценарий: Открытие формы списка "ЗаявкаНаВыплатуПрисоединенныеФайлы" 

	Дано Я открываю основную форму списка справочника "ЗаявкаНаВыплатуПрисоединенныеФайлы"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму справочника ЗаявкаНаВыплатуПрисоединенныеФайлы"
	И Я закрываю текущее окно

Сценарий: Открытие формы объекта "ЗаявкаНаВыплатуПрисоединенныеФайлы"

	Дано Я открываю основную форму справочника "ЗаявкаНаВыплатуПрисоединенныеФайлы"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму справочника ЗаявкаНаВыплатуПрисоединенныеФайлы"
	И Я закрываю текущее окно
