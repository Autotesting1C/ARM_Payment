...
Функционал: <2. ТЛБ, Нерезидент, более 15 000р но менее 600 000р , безнал выплата>
...
И Я закрываю все окна клиентского приложения
Сценарий: <Проверяем выплату ТЛБ билетов свыше 15000, но меньше 600 000 рублей. Безналичная выплата>
...
И из выпадающего списка с именем "ActiveFieldElement" я выбираю точное значение 'Участник'
И из выпадающего списка с именем "FindPatternElement" я выбираю точное значение 'Участник Для Автотестов Не Трогать Руками'
...
И я выбираю пункт контекстного меню с именем 'ВыплатыВРаботеНайти' на элементе формы с именем "ВыплатыВРаботе"
Тогда открылось окно 'Найти'
И из выпадающего списка с именем "ActiveFieldElement" я выбираю точное значение 'Номер билета'
И в поле с именем 'FindPatternElement' я ввожу значение переменной "НомерБилетаПерем"
И я нажимаю на кнопку с именем 'Find'
Тогда открылось окно 'АРМ выплат'
И в таблице "Билеты" я активизирую поле с именем "ВыплатыНомерСтроки"
И в таблице "Билеты" я активизирую поле с именем "ВыплатыОрганизатор"
...
И В командном интерфейсе я выбираю 'Администрирование' 'Поддержка и обслуживание'
Тогда открылось окно 'Поддержка и обслуживание'
...
И я нажимаю кнопку выбора у поля с именем "ПредставлениеИзменяемыхОбъектов"
Тогда открылось окно 'Выберите изменяемые элементы'
И в таблице "ДоступныеОбъектыДляИзменения" я перехожу к строке:
	| 'Значение'      | 'Пометка' |
	| 'Реестр выплат' | 'Нет'     |
И в таблице "ДоступныеОбъектыДляИзменения" я изменяю флаг с именем 'ДоступныеОбъектыДляИзмененияПометка'
И в таблице "ДоступныеОбъектыДляИзменения" я активизирую поле с именем "ДоступныеОбъектыДляИзмененияЗначение"
И в таблице "ДоступныеОбъектыДляИзменения" я завершаю редактирование строки
И я нажимаю на кнопку с именем 'ФормаВыбрать'
Тогда открылось окно 'Групповое изменение реквизитов'
И я нажимаю на гиперссылку с именем "НастройкаОтбора"

Когда открылось окно 'Выбранные элементы'
...
Тогда открылось окно 'Выбранные элементы'
И в таблице "КомпоновщикНастроекНастройкиОтбор" я завершаю редактирование строки
И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюОбновить1' на элементе формы с именем "Список"
...
И я нажимаю на кнопку с именем 'ФормаИзменить'
Тогда открылось окно 'Поддержка и обслуживание'
И Я закрываю окно 'Поддержка и обслуживание'
